...
public class Folders123 {
   ...
   /* public WebDriver driver ;
	public  void Folders123(WebDriver driver )throws Exception
	{  
			  this.driver=driver;
	}*/
 ...
 
 {
  ...
  //Hello starts
  public synchronized static ArrayList<String>   Hello(String TestName,String  BrowserType)
  {
...
// starts TC148_Amazon folder creation  
	public  synchronized  static void FolderCreation(String sTestCaseName1)
	{
