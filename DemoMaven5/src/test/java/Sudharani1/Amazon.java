...
driver.findElement(By.xpath(OR.HelloSgnin_Click)).click();
Amazon.waitfor5seconds();
...
driver.findElement(By.xpath(OR.passwordloginbutton_click )).click();
Amazon.waitfor5seconds();
}
...
Actions actions = new Actions(driver);   
 WebElement ele=driver.findElement(By.xpath(OR.HelloSudhakar_spFocus));
 Amazon.waitfor5seconds();
 actions.moveToElement(ele).build().perform();



WebElement ele1=driver.findElement(By.xpath(OR.Signout_spClick));
Amazon.waitfor5seconds();
