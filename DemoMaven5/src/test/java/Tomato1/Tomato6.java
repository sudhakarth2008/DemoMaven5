...

{
	  ...
	  public static String TestName,ExecutionFlag,TestPriority,TestGroup,ChromeBrowser,IEBrowser,FireFoxBrowser;
		 ...
		 public  void DatadrivenTest()throws Exception
		 {
			 ...
			 {	 
				 Tomato6.TestName=eat.getCellData("E://TC27.xls","Sheet1",i,0);
				 Tomato6.ExecutionFlag=eat.getCellData("E://TC27.xls","Sheet1",i,1);
				 
				 Tomato6.TestPriority=eat.getCellData("E://TC27.xls","Sheet1",i,2);
				 Tomato6.TestGroup=eat.getCellData("E://TC27.xls","Sheet1",i,3);
				 Tomato6.ChromeBrowser=eat.getCellData("E://TC27.xls","Sheet1",i,4);
				 Tomato6.IEBrowser=eat.getCellData("E://TC27.xls","Sheet1",i,5);
				 Tomato6.FireFoxBrowser=eat.getCellData("E://TC27.xls","Sheet1",i,6);
				
				 
				 List<String> values = new ArrayList<String>();
				 values.add(Tomato6.ExecutionFlag); //0
				 values.add(Tomato6.TestPriority); //1
				 values.add(Tomato6.TestGroup);  // 2
				 values.add(Tomato6.ChromeBrowser); // 3
				 values.add(Tomato6.IEBrowser);//4
				 values.add(Tomato6.FireFoxBrowser);//5
				 hMap.put(Tomato6.TestName,values);

			System.out.println(" apple1.TestName  is :"+Tomato6.TestName);				
			System.out.println(" apple1.Test Name Parameters are  is :"+hMap.get(Tomato6.TestName));
