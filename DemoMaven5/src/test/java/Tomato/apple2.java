...
public class apple2
{
	...
	DepartingStartDate,ArrivingIn,ReturningEndMonth,ReturningEndDate,Airline,ServiceClass,Radiobutton;
	 ...
	 public static void allmethods()throws Exception
	 {
		...
		// apple2.MerucryFlightFinderBusiness(WebDriver driver,apple2.PassengersCount,apple2.DepartingFrom,
	 ...
	 public static void MerucryFlightFinderBusiness(WebDriver driver,String PassengersCount,String DepartingFrom,
