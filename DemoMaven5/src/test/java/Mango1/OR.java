...
//public static String Output_TotalTaxes="(.//*[normalize-space(text()) and normalize-space(.)='$44 USD'])[1]/following::font[3]";
//public static String Output_TotalPrice="(.//*[normalize-space(text()) and normalize-space(.)='Delivery Address (N/A for Ticketless Travel)'])[1]/following::font[5]";
public static String Logout="(.//*[normalize-space(text()) and normalize-space(.)='$584 USD'])[1]/following::img[4]";
}
